...
Все эти ФАЙЛЫ (не директории, а именно файлы) перенесите вручную в директорию вашего проекта /var/www/subscribe.
Если какие-либо файлы совпадают, то смело заменяйте прежние файлы из чистого ларавел на файлы из директории subscribe-files.
...
еще раз запустим/перезапустим локальный сервер от ларавел:
php artisan serve
